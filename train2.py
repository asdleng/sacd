...
LastEditTime: 2023-09-29 15:48:02
...
Date: 2023-09-29 10:42:41
LastEditors: asdleng lengjianghao2006@163.com
LastEditTime: 2023-09-29 10:56:47
FilePath: /highway/dsac/train.py
Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
'''
import os
...
from sacd.agent import SacdAgent2, SharedSacdAgent
...
def run(args):
    ...
    # Create environments.
    env = gym.make("myenvd",  render_mode='rgb_array')
    ...
    # Create the agent.
    Agent = SacdAgent2 if not args.shared else SharedSacdAgent
    agent = Agent(
